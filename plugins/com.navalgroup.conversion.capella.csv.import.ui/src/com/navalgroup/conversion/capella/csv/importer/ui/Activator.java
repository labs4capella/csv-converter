...
public class Activator extends AbstractUIPlugin {
	 ...
	 * The plug-in ID.
	 */
	public static final String PLUGIN_ID = "com.navalgroup.conversion.capella.csv.import.ui"; //$NON-NLS-1$
	...
	public static void logInfo(String message, Throwable e) {
		plugin.getLog().log(new Status(IStatus.INFO, PLUGIN_ID, message, e));
	}
}
